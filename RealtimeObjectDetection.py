...
class ImageObjectDetector:
	...
	def showOutput(self, name):
		cv.imshow(name, self.outputImage)

class RealtimeObjectDetector:
	def __init__(self):
		self.source = cv.VideoCapture(0)
		self.source.set(3,550)
		self.source.set(4,550)
		self.source.set(10,100)
